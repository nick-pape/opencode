...
import { Session, type Message } from "@papecode-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@papecode-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@papecode-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://papecode.ai/desktop-feedback")}
      renderPanel={() =>
