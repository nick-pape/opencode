export const dict = {
  ...
  "dialog.provider.papecode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.papecode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.papecodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez PapeCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w PapeCode.",
  ...
  "provider.connect.papecodeZen.line1":
    "PapeCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.papecodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.papecodeZen.visit.link": "papecode.ai/zen",
  "provider.connect.papecodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w PapeCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w PapeCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w papecode.json",
  ...
  "dialog.server.description": "Przełącz serwer PapeCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja PapeCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu PapeCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (papecode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "PapeCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla PapeCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd PapeCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy PapeCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw PapeCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania PapeCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji PapeCode.",
