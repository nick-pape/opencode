...
export const dict = {
  ...
  "dialog.provider.papecode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.papecode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.papecodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av PapeCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i PapeCode.",
  ...
  "provider.connect.papecodeZen.line1":
    "PapeCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.papecodeZen.visit.prefix": "Besøk ",
  "provider.connect.papecodeZen.visit.link": "papecode.ai/zen",
  "provider.connect.papecodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i PapeCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i PapeCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i papecode.json",
  ...
  "dialog.server.description": "Bytt hvilken PapeCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av PapeCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til PapeCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (papecode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at PapeCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "PapeCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør PapeCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for PapeCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan PapeCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om PapeCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan PapeCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når PapeCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av PapeCode.",
