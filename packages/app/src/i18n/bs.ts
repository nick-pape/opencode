export const dict = {
  ...
  "dialog.provider.papecode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.papecode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.papecodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje PapeCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u PapeCode-u.",
  ...
  "provider.connect.papecodeZen.line1":
    "PapeCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.papecodeZen.visit.prefix": "Posjeti ",
  "provider.connect.papecodeZen.visit.link": "papecode.ai/zen",
  "provider.connect.papecodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u PapeCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u PapeCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u papecode.json",
  ...
  "dialog.server.description": "Promijeni na koji se PapeCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija PapeCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku PapeCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (papecode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: PapeCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "PapeCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni PapeCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u PapeCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako PapeCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li PapeCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu PapeCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se PapeCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju PapeCode-a.",
