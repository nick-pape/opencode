...
beforeAll(async () => {
  ...
  mock.module("@papecode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@papecode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@papecode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@papecode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
