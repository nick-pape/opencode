...
import { Keybind } from "@papecode-ai/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_PAPECODE_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("papecode-titlebar-center"))
    setRightMount(document.getElementById("papecode-titlebar-right"))
  })
