...
Crea `.papecode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di PapeCode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di PapeCode:
...
- Globale: `~/.config/papecode/commands/`
- Per progetto: `.papecode/commands/`
...
papecode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
