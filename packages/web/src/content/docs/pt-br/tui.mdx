---
title: TUI
description: Usando a interface de usuário de terminal papecode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O papecode fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar papecode inicia o TUI para o diretório atual.
...
Ao usar o TUI do papecode, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao papecode. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do papecode. _Aliases_: `/quit`, `/q`
...
Isso é separado do `papecode.json`, que configura o comportamento do servidor/runtime.
...
Use `PAPECODE_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
