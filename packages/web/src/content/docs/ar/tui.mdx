---
title: TUI
description: استخدام واجهة المستخدم TUI في PapeCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر PapeCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل PapeCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة PapeCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى PapeCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من PapeCode. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات PapeCode.
...
استخدم `PAPECODE_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
