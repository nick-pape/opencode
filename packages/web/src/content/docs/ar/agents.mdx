...
يوجد نوعان من الوكلاء في PapeCode: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي PapeCode مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي PapeCode مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي PapeCode مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `papecode.json`:
...
- عام: `~/.config/papecode/agents/`
- لكل مشروع: `.papecode/agents/`
...
إذا لم يتم تحديد temperature، يستخدم PapeCode القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات PapeCode العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات PapeCode الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [PapeCode Zen](/docs/zen)، فستستخدم `papecode/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `papecode models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/papecode).
:::
