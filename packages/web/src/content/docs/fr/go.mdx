...
PapeCode Go est un abonnement à bas coût — **5 $ pour votre premier mois**, puis **10 $/mois** — qui vous donne un accès fiable aux modèles de codage ouverts populaires.

:::note
PapeCode Go est actuellement en version bêta.
:::

Go fonctionne comme n'importe quel autre fournisseur dans PapeCode. Vous vous abonnez à PapeCode Go et obtenez votre clé d'API. C'est **totalement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser PapeCode.
...
PapeCode Go vous donne accès à ces modèles pour **5 $ pour votre premier mois**, puis **10 $/mois**.

---

## Comment ça marche

PapeCode Go fonctionne comme n'importe quel autre fournisseur dans PapeCode.

1. Vous vous connectez à **<a href={console}>PapeCode Zen</a>**, vous vous abonnez à Go et copiez votre clé d'API.
2. Vous exécutez la commande `/connect` dans la TUI, sélectionnez `PapeCode Go` et collez votre clé d'API.
3. Exécutez `/models` dans la TUI pour voir la liste des modèles disponibles via Go.

:::note
Un seul membre par espace de travail peut s'abonner à PapeCode Go.
:::
...
PapeCode Go inclut les limites suivantes :
...
| ----------------- | ----------------- | ------------------------------------------------ | --------------------------- |
| GLM-5.1           | glm-5.1           | `https://papecode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5             | glm-5             | `https://papecode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.5         | kimi-k2.5         | `https://papecode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.6         | kimi-k2.6         | `https://papecode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Pro   | deepseek-v4-pro   | `https://papecode.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| DeepSeek V4 Flash | deepseek-v4-flash | `https://papecode.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiMo-V2-Pro       | mimo-v2-pro       | `https://papecode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2-Omni      | mimo-v2-omni      | `https://papecode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5-Pro     | mimo-v2.5-pro     | `https://papecode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5         | mimo-v2.5         | `https://papecode.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M2.7      | minimax-m2.7      | `https://papecode.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5      | minimax-m2.5      | `https://papecode.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus      | qwen3.6-plus      | `https://papecode.ai/zen/go/v1/chat/completions` | `@ai-sdk/alibaba`           |
| Qwen3.5 Plus      | qwen3.5-plus      | `https://papecode.ai/zen/go/v1/chat/completions` | `@ai-sdk/alibaba`           |

L'[ID de modèle](/docs/config/#models) dans votre configuration PapeCode utilise le format `papecode-go/<model-id>`. Par exemple, pour Kimi K2.6, vous utiliseriez `papecode-go/kimi-k2.6` dans votre configuration.
...
Nous avons créé PapeCode Go pour :
...
4. N'avoir **aucun verrouillage exclusif** en vous permettant d'utiliser n'importe quel autre fournisseur avec PapeCode également.
