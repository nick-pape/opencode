---
title: Zen
description: Liste organisée de modèles fournis par PapeCode.
---
...
PapeCode Zen est une liste de modèles testés et vérifiés fournie par l'équipe PapeCode.

:::note
PapeCode Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans PapeCode. Vous vous connectez à PapeCode Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser PapeCode.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec PapeCode.
:::
...
PapeCode Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

PapeCode Zen fonctionne comme n'importe quel autre fournisseur dans PapeCode.

1. Vous vous connectez à **<a href={console}>PapeCode Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez PapeCode Zen et collez votre clé API.
...
| --------------------- | --------------------- | -------------------------------------------------- | --------------------------- |
| GPT 5.5               | gpt-5.5               | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.5 Pro           | gpt-5.5-pro           | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4               | gpt-5.4               | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Pro           | gpt-5.4-pro           | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Mini          | gpt-5.4-mini          | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Nano          | gpt-5.4-nano          | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex         | gpt-5.3-codex         | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex Spark   | gpt-5.3-codex-spark   | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2               | gpt-5.2               | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2 Codex         | gpt-5.2-codex         | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1               | gpt-5.1               | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex         | gpt-5.1-codex         | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max     | gpt-5.1-codex-max     | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini    | gpt-5.1-codex-mini    | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5                 | gpt-5                 | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Codex           | gpt-5-codex           | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Nano            | gpt-5-nano            | `https://papecode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| Claude Opus 4.7       | claude-opus-4-7       | `https://papecode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.6       | claude-opus-4-6       | `https://papecode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.5       | claude-opus-4-5       | `https://papecode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.1       | claude-opus-4-1       | `https://papecode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.6     | claude-sonnet-4-6     | `https://papecode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.5     | claude-sonnet-4-5     | `https://papecode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4       | claude-sonnet-4       | `https://papecode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5      | claude-haiku-4-5      | `https://papecode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5      | claude-3-5-haiku      | `https://papecode.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Gemini 3.1 Pro        | gemini-3.1-pro        | `https://papecode.ai/zen/v1/models/gemini-3.1-pro` | `@ai-sdk/google`            |
| Gemini 3 Flash        | gemini-3-flash        | `https://papecode.ai/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| Qwen3.6 Plus          | qwen3.6-plus          | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3.5 Plus          | qwen3.5-plus          | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5          | minimax-m2.5          | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5 Free     | minimax-m2.5-free     | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.7          | minimax-m2.7          | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 5.1               | glm-5.1               | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 5                 | glm-5                 | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5             | kimi-k2.5             | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.6             | kimi-k2.6             | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Big Pickle            | big-pickle            | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Ling 2.6 Flash        | ling-2.6-flash        | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Hy3 Preview Free      | hy3-preview-free      | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Nemotron 3 Super Free | nemotron-3-super-free | `https://papecode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

Le [model id](/docs/config/#models) dans votre configuration PapeCode utilise le format `papecode/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `papecode/gpt-5.5` dans votre configuration.
...
```
https://papecode.ai/zen/v1/models
```
...
- MiniMax M2.5 Free est disponible sur PapeCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Ling 2.6 Flash Free est disponible sur PapeCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Hy3 Preview Free est disponible sur PapeCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Super Free est disponible sur PapeCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur PapeCode pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
Nous avons créé PapeCode Zen pour :
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec PapeCode également.
