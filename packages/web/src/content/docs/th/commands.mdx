...
สร้าง `.papecode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ PapeCode:
...
- ระดับผู้ใช้ (Global): `~/.config/papecode/commands/`
- ระดับโปรเจ็กต์: `.papecode/commands/`
...
PapeCode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
