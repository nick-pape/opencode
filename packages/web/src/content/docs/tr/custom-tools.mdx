---
title: Özel Araçlar
description: LLM'un papecode'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. papecode'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.papecode/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/papecode/tools/` içine yerleştirerek.
