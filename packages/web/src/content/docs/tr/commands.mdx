...
`.papecode/commands/test.md` oluştur:
...
papecode işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

papecode [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/papecode/commands/`
- Proje başına: `.papecode/commands/`
...
papecode, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
