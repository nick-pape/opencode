---
title: Paylasim
description: papecode konusmalarini genel baglantilarla paylasin.
---

papecode'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda papecode:
...
papecode, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak papecode manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `papecode.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda papecode kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
