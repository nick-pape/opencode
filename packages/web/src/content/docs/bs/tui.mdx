---
title: TUI
description: Korištenje korisničkog interfejsa PapeCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

PapeCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje PapeCode pokreće TUI za trenutni direktorij.
...
Kada koristite PapeCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u PapeCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz PapeCode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `papecode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `PAPECODE_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
