...
Kreiraj `.papecode/commands/test.md`:
...
Možete dodati prilagođene komande kroz PapeCode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom PapeCode [config](/docs/config):
...
- Globalno: `~/.config/papecode/commands/`
- Po projektu: `.papecode/commands/`
...
PapeCode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
