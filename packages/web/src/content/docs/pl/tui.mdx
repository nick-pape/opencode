---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala papecode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

papecode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie papecode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI papecode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do papecode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij papecode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `papecode.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `PAPECODE_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
