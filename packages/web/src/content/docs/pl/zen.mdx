---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez PapeCode.
---
...
PapeCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół PapeCode.

:::note
PapeCode Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w PapeCode. Logujesz się do PapeCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z PapeCode.
:::
...
PapeCode Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

PapeCode Zen działa jak każdy inny dostawca w PapeCode.

1. Logujesz się do **<a href={console}>PapeCode Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz PapeCode Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji PapeCode używa formatu
`papecode/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`papecode/gpt-5.5`.
...
- MiniMax M2.5 Free jest dostępny w PapeCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 2.6 Flash Free jest dostępny w PapeCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Hy3 Preview Flash Free jest dostępny w PapeCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w PapeCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w PapeCode przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w PapeCode także dowolnego innego dostawcy.
