...
Utwórz `.papecode/commands/test.md`:
...
Możesz zdefiniować polecenia w `papecode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji papecode:
...
- Globalnie: `~/.config/papecode/commands/`
- Na projekt: `.papecode/commands/`
...
papecode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
