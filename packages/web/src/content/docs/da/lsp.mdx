---
title: LSP-servere
description: PapeCode integreres med dine LSP-servere.
---

PapeCode integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

PapeCode leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `PAPECODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når papecode åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din papecode-konfiguration.
