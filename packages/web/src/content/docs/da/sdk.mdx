...
Brug den til at bygge integrasjoner og kontrollere papecode programmatisk.
...
Opret en forekomst av papecode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `papecode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av papecode, kan du oprete en klientforekomst for at koble til den:
