...
Opret `.papecode/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem PapeCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din PapeCode [config](/docs/config):
...
- Globalt: `~/.config/papecode/commands/`
- Pr. projekt: `.papecode/commands/`
...
papecode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
