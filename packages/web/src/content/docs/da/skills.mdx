...
Agentferdigheter lar PapeCode oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går PapeCode opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
PapeCode viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `papecode.json`:
