...
Her er alle de innebygde verktøyene som er tilgængelige i PapeCode.
...
:::note
Dette verktøyet er bare tilgængelig når `PAPECODE_EXPERIMENTAL_LSP_TOOL=true` (eller `PAPECODE_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger PapeCode-leverandøren eller når miljøvariabelen `PAPECODE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
