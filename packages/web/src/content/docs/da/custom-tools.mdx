...
description: Opret værktøjer, som LLM kan kalde papecode ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med papecodes [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.papecode/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/papecode/tools/`.
