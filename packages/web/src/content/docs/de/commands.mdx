...
Erstellen Sie `.papecode/commands/test.md`:

```md title=".papecode/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die PapeCode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem PapeCode [config](/docs/config):

```json title="papecode.jsonc" {4-12}
{
...
- Global: `~/.config/papecode/commands/`
- Pro Projekt: `.papecode/commands/`

```markdown title="~/.config/papecode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".papecode/commands/component.md"
---
...
```md title=".papecode/commands/create-file.md"
---
...
```md title=".papecode/commands/analyze-coverage.md"
---
...
```md title=".papecode/commands/review-changes.md"
---
...
```md title=".papecode/commands/review-component.md"
---
...
PapeCode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
