---
title: TUI
description: Arbeite mit PapeCode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

PapeCode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet PapeCode die TUI im aktuellen Verzeichnis.
...
In der PapeCode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu PapeCode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet PapeCode. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `papecode.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `PAPECODE_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
