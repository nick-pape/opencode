---
title: Teilen
description: Teile PapeCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu PapeCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht PapeCode Folgendes:
...
PapeCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt PapeCode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`papecode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du papecode in deiner Organisation einsetzt.
