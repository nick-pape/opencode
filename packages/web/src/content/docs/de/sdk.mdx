---
title: SDK
description: Typsicherer JS-Client fuer den papecode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das papecode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und papecode programmatisch steuern.
...
Erstelle eine papecode-Instanz:
...
`papecode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn papecode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
