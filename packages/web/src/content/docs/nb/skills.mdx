...
Agentferdigheter lar PapeCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
papecode søker etter disse stedene:

- Prosjektkonfigurasjon: `.papecode/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/papecode/skills/<name>/SKILL.md`
...
For prosjektlokale stier går papecode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.papecode/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/papecode/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.papecode/skills/git-release/SKILL.md` slik:
...
papecode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `papecode.json`:
...
**For innebygde agenter** (i `papecode.json`):
