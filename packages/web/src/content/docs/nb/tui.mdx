---
title: TUI
description: Bruke papecode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

PapeCode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre PapeCode starter TUI for gjeldende katalog.
...
Når du bruker PapeCode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til PapeCode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt PapeCode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `papecode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `PAPECODE_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
