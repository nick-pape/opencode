...
Opprett `.papecode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom PapeCode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i PapeCode [config](/docs/config):
...
- Per prosjekt: `.papecode/commands/`
...
PapeCode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
