...
Crear `.papecode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración PapeCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su PapeCode [config](/docs/config):
...
- Por proyecto: `.papecode/commands/`
...
papecode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
