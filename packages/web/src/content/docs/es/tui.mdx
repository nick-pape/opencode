---
title: TUI
description: Usando la interfaz de usuario del terminal PapeCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

PapeCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar PapeCode se inicia TUI para el directorio actual.
...
Cuando utilice PapeCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a PapeCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de PapeCode. _Alias_: `/quit`, `/q`
...
Esto es independiente de `papecode.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `PAPECODE_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
