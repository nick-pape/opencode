...
import { IconPapecode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "papecode/session/message-v2"
import type { Message } from "papecode/session/message"
import type { Session } from "papecode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.papecode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.papecode_name}>
                    <IconPapecode width={16} height={16} />
                  </div>
