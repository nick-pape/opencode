import type * as SDK from "@papecode-ai/sdk/v2"
...
const disabled = process.env["PAPECODE_DISABLE_SHARE"] === "true" || process.env["PAPECODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@papecode/ShareNext") {}
