...
const PAPECODE_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  if (!Flag.PAPECODE_DISABLE_EXTERNAL_SKILLS) {
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, PAPECODE_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@papecode/Skill") {}
