...
function create(opts: { cors?: string[] }) {
  ...
  if (Flag.PAPECODE_WORKSPACE_ID) {
    return {
      app: app
        .use(InstanceMiddleware(Flag.PAPECODE_WORKSPACE_ID ? WorkspaceID.make(Flag.PAPECODE_WORKSPACE_ID) : undefined))
        .use(FenceMiddleware)
