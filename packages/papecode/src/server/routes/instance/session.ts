  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all PapeCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific PapeCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new PapeCode session for interacting with AI assistants and managing conversations.",
