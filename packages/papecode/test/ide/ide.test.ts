...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders PAPECODE_CALLER", () => {
    process.env["PAPECODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode PAPECODE_CALLER", () => {
    process.env["PAPECODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown PAPECODE_CALLER", () => {
    process.env["PAPECODE_CALLER"] = "unknown"
