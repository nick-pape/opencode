...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/papecode.git")).toEqual({ owner: "sst", repo: "papecode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/papecode")).toEqual({ owner: "sst", repo: "papecode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/papecode.git")).toEqual({ owner: "sst", repo: "papecode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/papecode")).toEqual({ owner: "sst", repo: "papecode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/papecode.git")).toEqual({ owner: "sst", repo: "papecode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/papecode")).toEqual({ owner: "sst", repo: "papecode" })
})
