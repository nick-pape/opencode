...
import compareVideo from "../../asset/lander/papecode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/papecode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="papecode:auth" content={loggedin() ? "true" : "false"} />
