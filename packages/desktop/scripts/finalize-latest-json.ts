...
const releaseId = process.env.PAPECODE_RELEASE
if (!releaseId) throw new Error("PAPECODE_RELEASE is required")

const version = process.env.PAPECODE_VERSION
if (!version) throw new Error("PAPECODE_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "papecode-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "papecode-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "papecode-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "papecode-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "papecode-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "papecode-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "papecode-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "papecode-desktop-darwin-aarch64.app.tar.gz",
  },
]
