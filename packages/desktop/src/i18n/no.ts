export const dict = {
  ...
  "desktop.menu.help.documentation": "PapeCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "PapeCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
