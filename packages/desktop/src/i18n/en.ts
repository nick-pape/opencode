export const dict = {
  ...
  "desktop.menu.help.documentation": "PapeCode Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "PapeCode CLI binary is missing. Try reinstalling the desktop app.",
