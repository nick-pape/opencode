...
Generates UPCOMING_CHANGELOG.md by running the papecode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for papecode run (default: low)
      --quiet            Suppress papecode command output unless it fails
