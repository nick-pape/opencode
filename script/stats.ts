...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/papecode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/papecode...\n")
...
console.log("Fetching npm all-time downloads for papecode-ai...\n")
const npmDownloads = await fetchNpmDownloads("papecode-ai")
