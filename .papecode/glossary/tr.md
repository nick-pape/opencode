...
- PR #15835: https://github.com/anomalyco/papecode/pull/15835

## Do Not Translate (Locale Additions)

- `PapeCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `papecode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `PapeCode` in prose, `papecode` only for exact technical identifiers
...
- Avoid changing `papecode` to `PapeCode` inside commands, URLs, package names, or code literals
