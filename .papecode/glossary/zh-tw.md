...
- PR #13942: https://github.com/anomalyco/papecode/pull/13942

## Do Not Translate (Locale Additions)

- `PapeCode` (preserve casing in prose; keep `papecode` only when it is part of commands, package names, paths, or code)
- `PapeCode Zen`
- `PapeCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `papecode` in prose when referring to the product name; use `PapeCode`
