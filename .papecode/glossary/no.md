...
- PR #10018: https://github.com/anomalyco/papecode/pull/10018
- PR #12935: https://github.com/anomalyco/papecode/pull/12935

## Do Not Translate (Locale Additions)

- `PapeCode` (preserve casing in prose; keep `papecode` only in commands, package names, paths, or code)
- `PapeCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
